# Moving through programs^[For Vim version 7.4.  Last change: 2008 Jun
# 28]
...
The nice thing about this is that Exuberant ctags recognizes various
...
You will get the first match.  If it's not the one you want, press
