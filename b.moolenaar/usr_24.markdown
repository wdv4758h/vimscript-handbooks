Inserting quickly^[For Vim version 7.4.  Last change: 2006 Jul 23]
=================
...
A special option for completion is `'infercase'`.  This is useful to
...
The function name is defined in a different file.  Edit that file and
