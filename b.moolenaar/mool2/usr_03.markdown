...
You will notice that when you type the `"/"` the cursor jumps to the
...
If you know what a previously used pattern starts with, and you want to
...
The `":jumps"` command gives a list of positions you jumped to.  The
