Editing formatted text^[For Vim version 7.4.  Last change: 2007 May 11]
======================
...
Unlike `":center"` and `":right"`, however, the argument to `":left"` is
...
When `'wrap'` is off and the text has scrolled horizontally, you can use
